...
class IndContactResourceIT {
    ...
    void putNewIndContact() throws Exception {
        ...
        updatedIndContact.preferred(UPDATED_PREFERRED).type(UPDATED_TYPE).validFrom(UPDATED_VALID_FROM).validTo(UPDATED_VALID_TO);
    ...
    void partialUpdateIndContactWithPatch() throws Exception {
        ...
        partialUpdatedIndContact.preferred(UPDATED_PREFERRED).type(UPDATED_TYPE).validFrom(UPDATED_VALID_FROM);
    ...
    void fullUpdateIndContactWithPatch() throws Exception {
        ...
        partialUpdatedIndContact.preferred(UPDATED_PREFERRED).type(UPDATED_TYPE).validFrom(UPDATED_VALID_FROM).validTo(UPDATED_VALID_TO);
