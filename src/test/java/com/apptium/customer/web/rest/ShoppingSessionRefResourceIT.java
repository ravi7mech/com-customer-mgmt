...
class ShoppingSessionRefResourceIT {
    ...
    void createShoppingSessionRef() throws Exception {
        ...
        assertThat(testShoppingSessionRef.getUserId()).isEqualTo(DEFAULT_USER_ID);
    }
    ...
    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsEqualToSomething() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId equals to DEFAULT_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.equals=" + DEFAULT_USER_ID);

        // Get all the shoppingSessionRefList where userId equals to UPDATED_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.equals=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId not equals to DEFAULT_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.notEquals=" + DEFAULT_USER_ID);

        // Get all the shoppingSessionRefList where userId not equals to UPDATED_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.notEquals=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsInShouldWork() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId in DEFAULT_USER_ID or UPDATED_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.in=" + DEFAULT_USER_ID + "," + UPDATED_USER_ID);

        // Get all the shoppingSessionRefList where userId equals to UPDATED_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.in=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId is not null
        defaultShoppingSessionRefShouldBeFound("userId.specified=true");

        // Get all the shoppingSessionRefList where userId is null
        defaultShoppingSessionRefShouldNotBeFound("userId.specified=false");
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId is greater than or equal to DEFAULT_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.greaterThanOrEqual=" + DEFAULT_USER_ID);

        // Get all the shoppingSessionRefList where userId is greater than or equal to UPDATED_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.greaterThanOrEqual=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId is less than or equal to DEFAULT_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.lessThanOrEqual=" + DEFAULT_USER_ID);

        // Get all the shoppingSessionRefList where userId is less than or equal to SMALLER_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.lessThanOrEqual=" + SMALLER_USER_ID);
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsLessThanSomething() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId is less than DEFAULT_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.lessThan=" + DEFAULT_USER_ID);

        // Get all the shoppingSessionRefList where userId is less than UPDATED_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.lessThan=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    void getAllShoppingSessionRefsByUserIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        shoppingSessionRefRepository.saveAndFlush(shoppingSessionRef);

        // Get all the shoppingSessionRefList where userId is greater than DEFAULT_USER_ID
        defaultShoppingSessionRefShouldNotBeFound("userId.greaterThan=" + DEFAULT_USER_ID);

        // Get all the shoppingSessionRefList where userId is greater than SMALLER_USER_ID
        defaultShoppingSessionRefShouldBeFound("userId.greaterThan=" + SMALLER_USER_ID);
    }
    ...
    void putNewShoppingSessionRef() throws Exception {
        ...
        assertThat(testShoppingSessionRef.getUserId()).isEqualTo(UPDATED_USER_ID);
    }
