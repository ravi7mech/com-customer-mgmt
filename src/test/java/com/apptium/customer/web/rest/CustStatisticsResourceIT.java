...
class CustStatisticsResourceIT {
    ...
    public static CustStatistics createEntity(EntityManager em) {
        CustStatistics custStatistics = new CustStatistics().name(DEFAULT_NAME).value(DEFAULT_VALUE).valuetype(DEFAULT_VALUETYPE);
    ...
    public static CustStatistics createUpdatedEntity(EntityManager em) {
        CustStatistics custStatistics = new CustStatistics().name(UPDATED_NAME).value(UPDATED_VALUE).valuetype(UPDATED_VALUETYPE);
        return custStatistics;
    }
    ...
    void putNewCustStatistics() throws Exception {
        ...
        updatedCustStatistics.name(UPDATED_NAME).value(UPDATED_VALUE).valuetype(UPDATED_VALUETYPE);
    ...
    void fullUpdateCustStatisticsWithPatch() throws Exception {
        ...
        partialUpdatedCustStatistics.name(UPDATED_NAME).value(UPDATED_VALUE).valuetype(UPDATED_VALUETYPE);
