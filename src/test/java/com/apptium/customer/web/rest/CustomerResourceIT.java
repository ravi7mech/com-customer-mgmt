...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_COMP_ID_TYPE = "AAAAAAAAAA";
    private static final String UPDATED_COMP_ID_TYPE = "BBBBBBBBBB";

    private static final Long DEFAULT_COMP_ID = 1L;
    private static final Long UPDATED_COMP_ID = 2L;
    private static final Long SMALLER_COMP_ID = 1L - 1L;
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .compIdType(DEFAULT_COMP_ID_TYPE)
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .compIdType(UPDATED_COMP_ID_TYPE)
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCompIdType()).isEqualTo(DEFAULT_COMP_ID_TYPE);
        assertThat(testCustomer.getCompId()).isEqualTo(DEFAULT_COMP_ID);
    ...
    @Test
    @Transactional
    void checkCompIdTypeIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setCompIdType(null);
    ...
    @Test
    @Transactional
    void checkCompIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setCompId(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].compIdType").value(hasItem(DEFAULT_COMP_ID_TYPE)))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.compIdType").value(DEFAULT_COMP_ID_TYPE))
    ...
    @Test
    @Transactional
    void getAllCustomersByCustEmailIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where custEmail equals to DEFAULT_CUST_EMAIL
        defaultCustomerShouldBeFound("custEmail.equals=" + DEFAULT_CUST_EMAIL);

        // Get all the customerList where custEmail equals to UPDATED_CUST_EMAIL
        defaultCustomerShouldNotBeFound("custEmail.equals=" + UPDATED_CUST_EMAIL);
    }

    @Test
    @Transactional
    void getAllCustomersByCustEmailIsNotEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where custEmail not equals to DEFAULT_CUST_EMAIL
        defaultCustomerShouldNotBeFound("custEmail.notEquals=" + DEFAULT_CUST_EMAIL);

        // Get all the customerList where custEmail not equals to UPDATED_CUST_EMAIL
        defaultCustomerShouldBeFound("custEmail.notEquals=" + UPDATED_CUST_EMAIL);
    }

    @Test
    @Transactional
    void getAllCustomersByCustEmailIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where custEmail in DEFAULT_CUST_EMAIL or UPDATED_CUST_EMAIL
        defaultCustomerShouldBeFound("custEmail.in=" + DEFAULT_CUST_EMAIL + "," + UPDATED_CUST_EMAIL);

        // Get all the customerList where custEmail equals to UPDATED_CUST_EMAIL
        defaultCustomerShouldNotBeFound("custEmail.in=" + UPDATED_CUST_EMAIL);
    }

    @Test
    @Transactional
    void getAllCustomersByCustEmailIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where custEmail is not null
        defaultCustomerShouldBeFound("custEmail.specified=true");

        // Get all the customerList where custEmail is null
        defaultCustomerShouldNotBeFound("custEmail.specified=false");
    }

    @Test
    @Transactional
    void getAllCustomersByCustEmailContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where custEmail contains DEFAULT_CUST_EMAIL
        defaultCustomerShouldBeFound("custEmail.contains=" + DEFAULT_CUST_EMAIL);

        // Get all the customerList where custEmail contains UPDATED_CUST_EMAIL
        defaultCustomerShouldNotBeFound("custEmail.contains=" + UPDATED_CUST_EMAIL);
    }

    @Test
    @Transactional
    void getAllCustomersByCustEmailNotContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where custEmail does not contain DEFAULT_CUST_EMAIL
        defaultCustomerShouldNotBeFound("custEmail.doesNotContain=" + DEFAULT_CUST_EMAIL);

        // Get all the customerList where custEmail does not contain UPDATED_CUST_EMAIL
        defaultCustomerShouldBeFound("custEmail.doesNotContain=" + UPDATED_CUST_EMAIL);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compIdType equals to DEFAULT_COMP_ID_TYPE
        defaultCustomerShouldBeFound("compIdType.equals=" + DEFAULT_COMP_ID_TYPE);

        // Get all the customerList where compIdType equals to UPDATED_COMP_ID_TYPE
        defaultCustomerShouldNotBeFound("compIdType.equals=" + UPDATED_COMP_ID_TYPE);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdTypeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compIdType not equals to DEFAULT_COMP_ID_TYPE
        defaultCustomerShouldNotBeFound("compIdType.notEquals=" + DEFAULT_COMP_ID_TYPE);

        // Get all the customerList where compIdType not equals to UPDATED_COMP_ID_TYPE
        defaultCustomerShouldBeFound("compIdType.notEquals=" + UPDATED_COMP_ID_TYPE);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdTypeIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compIdType in DEFAULT_COMP_ID_TYPE or UPDATED_COMP_ID_TYPE
        defaultCustomerShouldBeFound("compIdType.in=" + DEFAULT_COMP_ID_TYPE + "," + UPDATED_COMP_ID_TYPE);

        // Get all the customerList where compIdType equals to UPDATED_COMP_ID_TYPE
        defaultCustomerShouldNotBeFound("compIdType.in=" + UPDATED_COMP_ID_TYPE);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdTypeIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compIdType is not null
        defaultCustomerShouldBeFound("compIdType.specified=true");

        // Get all the customerList where compIdType is null
        defaultCustomerShouldNotBeFound("compIdType.specified=false");
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdTypeContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compIdType contains DEFAULT_COMP_ID_TYPE
        defaultCustomerShouldBeFound("compIdType.contains=" + DEFAULT_COMP_ID_TYPE);

        // Get all the customerList where compIdType contains UPDATED_COMP_ID_TYPE
        defaultCustomerShouldNotBeFound("compIdType.contains=" + UPDATED_COMP_ID_TYPE);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdTypeNotContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compIdType does not contain DEFAULT_COMP_ID_TYPE
        defaultCustomerShouldNotBeFound("compIdType.doesNotContain=" + DEFAULT_COMP_ID_TYPE);

        // Get all the customerList where compIdType does not contain UPDATED_COMP_ID_TYPE
        defaultCustomerShouldBeFound("compIdType.doesNotContain=" + UPDATED_COMP_ID_TYPE);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId equals to DEFAULT_COMP_ID
        defaultCustomerShouldBeFound("compId.equals=" + DEFAULT_COMP_ID);

        // Get all the customerList where compId equals to UPDATED_COMP_ID
        defaultCustomerShouldNotBeFound("compId.equals=" + UPDATED_COMP_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId not equals to DEFAULT_COMP_ID
        defaultCustomerShouldNotBeFound("compId.notEquals=" + DEFAULT_COMP_ID);

        // Get all the customerList where compId not equals to UPDATED_COMP_ID
        defaultCustomerShouldBeFound("compId.notEquals=" + UPDATED_COMP_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId in DEFAULT_COMP_ID or UPDATED_COMP_ID
        defaultCustomerShouldBeFound("compId.in=" + DEFAULT_COMP_ID + "," + UPDATED_COMP_ID);

        // Get all the customerList where compId equals to UPDATED_COMP_ID
        defaultCustomerShouldNotBeFound("compId.in=" + UPDATED_COMP_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId is not null
        defaultCustomerShouldBeFound("compId.specified=true");

        // Get all the customerList where compId is null
        defaultCustomerShouldNotBeFound("compId.specified=false");
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId is greater than or equal to DEFAULT_COMP_ID
        defaultCustomerShouldBeFound("compId.greaterThanOrEqual=" + DEFAULT_COMP_ID);

        // Get all the customerList where compId is greater than or equal to UPDATED_COMP_ID
        defaultCustomerShouldNotBeFound("compId.greaterThanOrEqual=" + UPDATED_COMP_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId is less than or equal to DEFAULT_COMP_ID
        defaultCustomerShouldBeFound("compId.lessThanOrEqual=" + DEFAULT_COMP_ID);

        // Get all the customerList where compId is less than or equal to SMALLER_COMP_ID
        defaultCustomerShouldNotBeFound("compId.lessThanOrEqual=" + SMALLER_COMP_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsLessThanSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId is less than DEFAULT_COMP_ID
        defaultCustomerShouldNotBeFound("compId.lessThan=" + DEFAULT_COMP_ID);

        // Get all the customerList where compId is less than UPDATED_COMP_ID
        defaultCustomerShouldBeFound("compId.lessThan=" + UPDATED_COMP_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByCompIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where compId is greater than DEFAULT_COMP_ID
        defaultCustomerShouldNotBeFound("compId.greaterThan=" + DEFAULT_COMP_ID);

        // Get all the customerList where compId is greater than SMALLER_COMP_ID
        defaultCustomerShouldBeFound("compId.greaterThan=" + SMALLER_COMP_ID);
    }
    ...
    @Test
    @Transactional
    void getAllCustomersByCustBillArrangementIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);
        CustBillArrangement custBillArrangement = CustBillArrangementResourceIT.createEntity(em);
        em.persist(custBillArrangement);
        em.flush();
        customer.setCustBillArrangement(custBillArrangement);
        customerRepository.saveAndFlush(customer);
        Long custBillArrangementId = custBillArrangement.getId();

        // Get all the customerList where custBillArrangement equals to custBillArrangementId
        defaultCustomerShouldBeFound("custBillArrangementId.equals=" + custBillArrangementId);

        // Get all the customerList where custBillArrangement equals to (custBillArrangementId + 1)
        defaultCustomerShouldNotBeFound("custBillArrangementId.equals=" + (custBillArrangementId + 1));
    }
    ...
    void getAllCustomersByCustCreditProfileIsEqualToSomething() throws Exception {
        ...
        em.flush();
        customer.addCustCreditProfile(custCreditProfile);
        customerRepository.saveAndFlush(customer);
    ...
    void getAllCustomersByCustBillingRefIsEqualToSomething() throws Exception {
        ...
        em.flush();
        customer.addCustBillingRef(custBillingRef);
        customerRepository.saveAndFlush(customer);
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCompIdType()).isEqualTo(UPDATED_COMP_ID_TYPE);
        assertThat(testCustomer.getCompId()).isEqualTo(UPDATED_COMP_ID);
