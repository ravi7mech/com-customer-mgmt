...
class CustSecurityCharResourceIT {
    ...
    public static CustSecurityChar createEntity(EntityManager em) {
        CustSecurityChar custSecurityChar = new CustSecurityChar().name(DEFAULT_NAME).value(DEFAULT_VALUE).valueType(DEFAULT_VALUE_TYPE);
    ...
    public static CustSecurityChar createUpdatedEntity(EntityManager em) {
        CustSecurityChar custSecurityChar = new CustSecurityChar().name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
        return custSecurityChar;
    }
    ...
    void putNewCustSecurityChar() throws Exception {
        ...
        updatedCustSecurityChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
    ...
    void partialUpdateCustSecurityCharWithPatch() throws Exception {
        ...
        partialUpdatedCustSecurityChar.value(UPDATED_VALUE);
    ...
    void fullUpdateCustSecurityCharWithPatch() throws Exception {
        ...
        partialUpdatedCustSecurityChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
