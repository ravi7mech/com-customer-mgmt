...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().name(DEFAULT_NAME).departmentHead(DEFAULT_DEPARTMENT_HEAD).status(DEFAULT_STATUS);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().name(UPDATED_NAME).departmentHead(UPDATED_DEPARTMENT_HEAD).status(UPDATED_STATUS);
        return department;
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).departmentHead(UPDATED_DEPARTMENT_HEAD).status(UPDATED_STATUS);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentHead(UPDATED_DEPARTMENT_HEAD);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).departmentHead(UPDATED_DEPARTMENT_HEAD).status(UPDATED_STATUS);
