...
class CustCharResourceIT {
    ...
    public static CustChar createEntity(EntityManager em) {
        CustChar custChar = new CustChar().name(DEFAULT_NAME).value(DEFAULT_VALUE).valueType(DEFAULT_VALUE_TYPE);
        return custChar;
    }
    ...
    public static CustChar createUpdatedEntity(EntityManager em) {
        CustChar custChar = new CustChar().name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
        return custChar;
    }
    ...
    void putNewCustChar() throws Exception {
        ...
        updatedCustChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
    ...
    void fullUpdateCustCharWithPatch() throws Exception {
        ...
        partialUpdatedCustChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
