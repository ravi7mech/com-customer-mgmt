...
class GeographicSiteRefResourceIT {
    ...
    public static GeographicSiteRef createEntity(EntityManager em) {
        GeographicSiteRef geographicSiteRef = new GeographicSiteRef().siteRef(DEFAULT_SITE_REF).location(DEFAULT_LOCATION);
    ...
    public static GeographicSiteRef createUpdatedEntity(EntityManager em) {
        GeographicSiteRef geographicSiteRef = new GeographicSiteRef().siteRef(UPDATED_SITE_REF).location(UPDATED_LOCATION);
        return geographicSiteRef;
    }
    ...
    void putNewGeographicSiteRef() throws Exception {
        ...
        updatedGeographicSiteRef.siteRef(UPDATED_SITE_REF).location(UPDATED_LOCATION);
