...
class IndCharResourceIT {
    ...
    public static IndChar createEntity(EntityManager em) {
        IndChar indChar = new IndChar().name(DEFAULT_NAME).value(DEFAULT_VALUE).valueType(DEFAULT_VALUE_TYPE);
        return indChar;
    }
    ...
    public static IndChar createUpdatedEntity(EntityManager em) {
        IndChar indChar = new IndChar().name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
        return indChar;
    }
    ...
    void putNewIndChar() throws Exception {
        ...
        updatedIndChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
    ...
    void fullUpdateIndCharWithPatch() throws Exception {
        ...
        partialUpdatedIndChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
