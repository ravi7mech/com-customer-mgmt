...
class CustNewsLetterConfigResourceIT {
    ...
    void putNewCustNewsLetterConfig() throws Exception {
        ...
        updatedCustNewsLetterConfig.newLetterTypeId(UPDATED_NEW_LETTER_TYPE_ID).value(UPDATED_VALUE);
    ...
    void fullUpdateCustNewsLetterConfigWithPatch() throws Exception {
        ...
        partialUpdatedCustNewsLetterConfig.newLetterTypeId(UPDATED_NEW_LETTER_TYPE_ID).value(UPDATED_VALUE);
