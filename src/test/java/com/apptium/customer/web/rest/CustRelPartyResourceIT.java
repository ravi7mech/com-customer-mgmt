...
class CustRelPartyResourceIT {
    ...
    void putNewCustRelParty() throws Exception {
        ...
        updatedCustRelParty.name(UPDATED_NAME).roleId(UPDATED_ROLE_ID).validFrom(UPDATED_VALID_FROM).validTo(UPDATED_VALID_TO);
    ...
    void partialUpdateCustRelPartyWithPatch() throws Exception {
        ...
        partialUpdatedCustRelParty.roleId(UPDATED_ROLE_ID).validTo(UPDATED_VALID_TO);
    ...
    void fullUpdateCustRelPartyWithPatch() throws Exception {
        ...
        partialUpdatedCustRelParty.name(UPDATED_NAME).roleId(UPDATED_ROLE_ID).validFrom(UPDATED_VALID_FROM).validTo(UPDATED_VALID_TO);
