...
class IndNewsLetterConfResourceIT {
    ...
    public static IndNewsLetterConf createEntity(EntityManager em) {
        IndNewsLetterConf indNewsLetterConf = new IndNewsLetterConf().newLetterTypeId(DEFAULT_NEW_LETTER_TYPE_ID).value(DEFAULT_VALUE);
    ...
    public static IndNewsLetterConf createUpdatedEntity(EntityManager em) {
        IndNewsLetterConf indNewsLetterConf = new IndNewsLetterConf().newLetterTypeId(UPDATED_NEW_LETTER_TYPE_ID).value(UPDATED_VALUE);
        return indNewsLetterConf;
    }
    ...
    void putNewIndNewsLetterConf() throws Exception {
        ...
        updatedIndNewsLetterConf.newLetterTypeId(UPDATED_NEW_LETTER_TYPE_ID).value(UPDATED_VALUE);
    ...
    void partialUpdateIndNewsLetterConfWithPatch() throws Exception {
        ...
        partialUpdatedIndNewsLetterConf.newLetterTypeId(UPDATED_NEW_LETTER_TYPE_ID).value(UPDATED_VALUE);
