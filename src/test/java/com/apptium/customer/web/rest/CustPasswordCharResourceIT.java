...
class CustPasswordCharResourceIT {
    ...
    public static CustPasswordChar createEntity(EntityManager em) {
        CustPasswordChar custPasswordChar = new CustPasswordChar().name(DEFAULT_NAME).value(DEFAULT_VALUE).valueType(DEFAULT_VALUE_TYPE);
    ...
    public static CustPasswordChar createUpdatedEntity(EntityManager em) {
        CustPasswordChar custPasswordChar = new CustPasswordChar().name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
        return custPasswordChar;
    }
    ...
    void putNewCustPasswordChar() throws Exception {
        ...
        updatedCustPasswordChar.name(UPDATED_NAME).value(UPDATED_VALUE).valueType(UPDATED_VALUE_TYPE);
