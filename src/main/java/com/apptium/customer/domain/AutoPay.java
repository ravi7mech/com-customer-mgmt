...
public class AutoPay implements Serializable {
    ...
    public AutoPay custBillArrangement(CustBillArrangement custBillArrangement) {
    ...
    public void setCustBillArrangement(CustBillArrangement custBillArrangement) {
        if (this.custBillArrangement != null) {
            this.custBillArrangement.setAutoPay(null);
        }
        if (custBillArrangement != null) {
            custBillArrangement.setAutoPay(this);
        }
