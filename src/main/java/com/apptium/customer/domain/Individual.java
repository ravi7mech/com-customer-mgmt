...
public class Individual implements Serializable {
    ...
    public ShoppingSessionRef getShoppingSessionRef() {
        return this.shoppingSessionRef;
    }

    public Individual shoppingSessionRef(ShoppingSessionRef shoppingSessionRef) {
        this.setShoppingSessionRef(shoppingSessionRef);
        return this;
    }

    public void setShoppingSessionRef(ShoppingSessionRef shoppingSessionRef) {
        if (this.shoppingSessionRef != null) {
            this.shoppingSessionRef.setIndividual(null);
        }
        if (shoppingSessionRef != null) {
            shoppingSessionRef.setIndividual(this);
        }
        this.shoppingSessionRef = shoppingSessionRef;
    }
