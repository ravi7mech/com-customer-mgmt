 ...
 */
@Mapper(componentModel = "spring", uses = { CustBillingAccMapper.class, CustBillArrangementMapper.class })
public interface CustomerMapper extends EntityMapper<CustomerDTO, Customer> {
    @Mapping(target = "custBillingAcc", source = "custBillingAcc", qualifiedByName = "id")
    @Mapping(target = "custBillArrangement", source = "custBillArrangement", qualifiedByName = "id")
